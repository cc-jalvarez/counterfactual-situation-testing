...
# significance level -- use the Bonferroni correction: org. alpha / # of protected attributes
alpha = 0.05 / 2
# tau deviation
tau = 0.0
...
df_k_res_abs.to_csv(resu_path + os.sep + f'res_LawSchool_Multiple_abs.csv', sep='|', index=False)
df_k_res_prc.to_csv(resu_path + os.sep + f'res_LawSchool_Multiple_prc.csv', sep='|', index=False)
