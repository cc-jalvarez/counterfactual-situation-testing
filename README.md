...
Code for the working paper on Counterfactual Situtaion Testing: Uncovering Discrimination under Fairness given the Difference [[arXiv]](https://arxiv.org/abs/2302.11944).
