...
The scripts get_cf_data_< > generate the counterfactual dataset for the < > case. The scripts run_exp_< > run the experiments -- standard situation testing, counterfactual situation testing with/without centers, and counterfactual fairness -- for the < > case. 
